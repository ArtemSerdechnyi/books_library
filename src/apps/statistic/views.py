...
def statistic_page_view(request: WSGIRequest):
    """
    View function for rendering the main statistic page.
    """
...
def genres_statistic_view(request: WSGIRequest):
    """
    View function for rendering the genre statistics page.
    """
...
def fig_genres_statistic_view(request: WSGIRequest):
    """
    View function for rendering the figure genre statistics page.
    """
...
def authors_statistic_view(request: WSGIRequest):
    """
    View function for rendering the authors statistics page.
    """
...
def books_read_statistics_view(request: WSGIRequest):
    """
    View function for rendering the books read statistics page.
    """
